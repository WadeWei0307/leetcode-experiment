...
<h3>Thinking</h3><hr>
<p>
1. If current character is smaller then next character, using result to minus its number; otherwise using result to add its number. <br> </p>
<hr>
<h3>Time complexity</h3><hr>
<p>
1. We go through the length of the string, so is <strong>O(n)</strong>.
</p>
</div>