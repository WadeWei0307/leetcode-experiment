<h2><a href="https://leetcode.com/problems/range-sum-query-immutable/">303. Range Sum Query - Immutable</a></h2><h3>Easy</h3><hr>
...
<p>1. Store summation will go through vector, so is <strong>O(n)</strong>.</p>
<p>2. Return answer is <strong>O(1)</strong>, so final is <strong>O(n)</strong>.</p>
</div>