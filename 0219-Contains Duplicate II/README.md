...
<div class="elfjS" data-track-load="description_content"><p>Given an integer array <code>nums</code> and an integer <code>k</code>, return <code>true</code> <em>if there are two <strong>distinct indices</strong> </em><code>i</code><em> and </em><code>j</code><em> in the array such that </em><code>nums[i] == nums[j]</code><em> and </em><code>abs(i - j) &lt;= k</code>.</p>
...
<h3>Thinking</h3><hr>
<p>
1. Use hash table to remember each element first appear index.
</p>
<hr>
<h3>Time complexity</h3><hr>
<p>1. Go through vector, so is <strong>O(n)</strong>.</p>
</div>