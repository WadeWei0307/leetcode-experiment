...
<h3>Thinking</h3><hr>
<p>
1. We use two marker to mark the start and end.<br>
</p>
<p>
2. Choosing shorter be the height, then shorter side find the longer height forward.
</p>
<hr>
<h3>Time complexity</h3><hr>
<p>
1. Worst case is find out all height, so is <strong>O(n)</strong>.
</p>
</div>