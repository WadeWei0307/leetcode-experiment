...
<p>&nbsp;</p>
<strong>Follow up:</strong> Could you solve it without converting the integer to a string?<hr>

<h3>Thinking</h3><hr>
<p>
1. First, judge if palindrome is overflow from int, if so then break the while.<br>
</p>
<p>
2. Using % to get every number of digits, then sum it to check if is the same with input.
</p>
<hr>
<h3>Time complexity</h3><hr>
<p>
1. Is depend on how many number of digit, so is <strong>O(n)</strong>.
</p>
</div>