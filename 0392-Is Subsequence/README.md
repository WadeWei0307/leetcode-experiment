<h2><a href="https://leetcode.com/problems/is-subsequence/">392. Is Subsequence</a></h2><h3>Easy</h3><hr>
...
<hr>
<h3>Thinking</h3><hr>
<p>1. Just compare two char in each string, if pointer 'S' equal to string 's' length, represent each char in string 's' have appear in string 't' by order.</p>
<hr>
<h3>Time complexity</h3><hr>
<p>1. Depend on string 't' length, so is O(t.length()).</p>
</div>