...
<h3>Thinking</h3><hr>
<p>
1. Each coefficient can be combination of C<sup>rowIndex</sup><sub style="margin-left:-45px">i</sub>
</p>
<p>
2. Above i  can be the 0~rowIndex.
<hr>
<h3>Time complexity</h3><hr>
<p>
<p>1. Run the combination calculate of each coefficient, so is <strong>O(rowIndex)</strong> = <strong>O(n)</strong>.</p> 
</p>
</div>