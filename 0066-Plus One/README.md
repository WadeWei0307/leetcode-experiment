...
<h3>Thinking</h3><hr>
<p>
1. Go through <code>digits</code> every number of digit, and see if is 9 or not. Also, using carryBit if the current digit is 9 to let next digit to plus 1.<br> 
</p>
<hr>
<h3>Time complexity</h3><hr>
<p>
<p>1. Go through the size of vector, so is <strong>O(n)</strong>.</p> 
</p>
</div>